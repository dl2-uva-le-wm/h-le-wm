...
# Suggested use:
#   cd jobs/eval/hi/d50
#   sbatch d50_hierarchical_soft_low_h2_eval.sh

#SBATCH --partition=gpu_mig
#SBATCH --gpus=1
#SBATCH --job-name=hi_eval_d50_hier_soft_low_h2
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=8
#SBATCH --time=03:00:00
#SBATCH --output=d50_hierarchical_soft_low_h2_eval_%j.out
#SBATCH --error=d50_hierarchical_soft_low_h2_eval_%j.err
