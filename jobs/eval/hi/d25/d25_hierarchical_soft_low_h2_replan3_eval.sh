...
# Suggested use:
#   cd jobs/eval/hi/d25
#   sbatch d25_hierarchical_soft_low_h2_replan3_eval.sh

#SBATCH --partition=rome
#SBATCH --job-name=hi_eval_d25_hier_soft_low_h2_replan3
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=8
#SBATCH --time=02:00:00
#SBATCH --output=d25_hierarchical_soft_low_h2_replan3_eval_%j.out
#SBATCH --error=d25_hierarchical_soft_low_h2_replan3_eval_%j.err
