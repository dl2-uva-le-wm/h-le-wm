...
# Suggested use:
#   cd jobs/eval/hi
#   sbatch eval_hope1_short_hier_soft_lowh2_blk3_searchboost.sh

#SBATCH --partition=rome
#SBATCH --job-name=hi_eval_hope1_short_hier_soft_lowh2_blk5_searchboost
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=8
#SBATCH --time=03:00:00
#SBATCH --output=eval_hope1_short_hier_soft_lowh2_blk5_searchboost_%j.out
#SBATCH --error=eval_hope1_short_hier_soft_lowh2_blk5_searchboost_%j.err
