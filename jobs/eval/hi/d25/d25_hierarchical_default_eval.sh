...
# Usage:
#   cd jobs/eval/hi/d25
#   sbatch d25_hierarchical_default_eval.sh
#
# Common overrides:
#   sbatch --export=ALL,CHECKPOINT_EPOCH=8 d25_hierarchical_default_eval.sh
#   sbatch --export=ALL,RUN_NAME=hi_lewm_p2_train_hope1_21983875,CHECKPOINT_EPOCH=latest d25_hierarchical_default_eval.sh
#   sbatch --export=ALL,RESULT_FILENAME=my_eval_short_epoch8.txt d25_hierarchical_default_eval.sh
#   sbatch --export=ALL,EVAL_SUBDIR=my_custom_eval_subdir d25_hierarchical_default_eval.sh
#   sbatch --export=ALL,GOAL_OFFSET_STEPS=25 d25_hierarchical_default_eval.sh
#   sbatch --export=ALL,STABLEWM_HOME=/scratch-shared/$USER/stablewm_data d25_hierarchical_default_eval.sh

#SBATCH --partition=gpu_a100
#SBATCH --gpus=1
#SBATCH --job-name=hi_eval_d25_hier_default
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=8
#SBATCH --time=02:00:00
#SBATCH --output=d25_hierarchical_default_eval_%j.out
#SBATCH --error=d25_hierarchical_default_eval_%j.err
