...
# Snellius training job (OGBench-Cube):
...
#   TRAIN_RUN_NAME=hi_lewm_cube_train_hope1_custom sbatch train_hope1.sh
...
#SBATCH --gpus=1
#SBATCH --job-name=hi_l2_cube_train_hope1
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=9
#SBATCH --time=12:00:00
#SBATCH --output=train_cube_hope1_%j.out
#SBATCH --error=train_cube_hope1_%j.err
...
TRAIN_RUN_NAME="${TRAIN_RUN_NAME:-hi_lewm_cube_train_hope1_${SLURM_JOB_ID:-manual}}"
...
LOCAL_CKPT="${LOCAL_STABLEWM_HOME}/cube/lewm_object.ckpt"
