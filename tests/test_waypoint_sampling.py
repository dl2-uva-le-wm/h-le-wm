...
def _load_sampling_functions():
    """Load sampling functions from the canonical waypoint sampling module without heavy deps."""
    src_path = Path(__file__).resolve().parents[1] / "h_le_wm" / "models" / "waypoint_sampling.py"
