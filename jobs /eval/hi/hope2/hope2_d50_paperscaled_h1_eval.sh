...
# Hope2 PushT eval on d=50 with a higher-compute paper-scaled CEM budget and a
# short high-level horizon H=1.

#SBATCH --partition=rome
#SBATCH --job-name=hi_eval_hope2_d50_pscaled_h1
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=8
#SBATCH --time=05:00:00
#SBATCH --output=hope2_d50_paperscaled_h1_eval_%j.out
#SBATCH --error=hope2_d50_paperscaled_h1_eval_%j.err
...
export EVAL_SUBDIR="${EVAL_SUBDIR:-eval_hope2_d50_paperscaled_h1_b${EVAL_BUDGET}_job_${SLURM_JOB_ID:-$(date +%Y%m%d_%H%M%S)}}"
