...
# Usage:
#   cd jobs/eval/hi/d25
#   sbatch d25_hierarchical_soft_eval.sh
#
# Common overrides:
#   sbatch --export=ALL,CHECKPOINT_EPOCH=8 d25_hierarchical_soft_eval.sh
#   sbatch --export=ALL,HIGH_HORIZON=1,HIGH_REPLAN_INTERVAL=5 d25_hierarchical_soft_eval.sh
#   sbatch --export=ALL,LOW_TOPK=200 d25_hierarchical_soft_eval.sh

#SBATCH --partition=gpu_a100
#SBATCH --gpus=1
#SBATCH --job-name=hi_eval_d25_hier_soft
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=8
#SBATCH --time=02:00:00
#SBATCH --output=d25_hierarchical_soft_eval_%j.out
#SBATCH --error=d25_hierarchical_soft_eval_%j.err
