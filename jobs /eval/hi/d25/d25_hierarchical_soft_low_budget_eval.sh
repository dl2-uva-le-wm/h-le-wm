...
#
# Default behavior relative to d25_hierarchical_soft_eval.sh:
...
# Usage:
#   cd jobs/eval/hi/d25
#   sbatch d25_hierarchical_soft_low_budget_eval.sh
#
# Common overrides:
#   sbatch --export=ALL,CHECKPOINT_EPOCH=8 d25_hierarchical_soft_low_budget_eval.sh
#   sbatch --export=ALL,EVAL_BUDGET=20 d25_hierarchical_soft_low_budget_eval.sh

#SBATCH --partition=gpu_mig
#SBATCH --gpus=1
#SBATCH --job-name=hi_eval_d25_hier_soft_low_budget
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=8
#SBATCH --time=02:00:00
#SBATCH --output=d25_hierarchical_soft_low_budget_eval_%j.out
#SBATCH --error=d25_hierarchical_soft_low_budget_eval_%j.err
