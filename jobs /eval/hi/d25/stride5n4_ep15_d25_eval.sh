...
# its final object checkpoint (epoch 15), using the standard d=25 H=2 GPU setup.

#SBATCH --partition=gpu_a100
#SBATCH --gpus=1
#SBATCH --job-name=hi_eval_s5n4e15_d25
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=8
#SBATCH --time=02:30:00
#SBATCH --output=stride5n4_ep15_d25_eval_%j.out
#SBATCH --error=stride5n4_ep15_d25_eval_%j.err
