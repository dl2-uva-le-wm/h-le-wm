...
# epoch 25, using the stronger paper-scaled d50 CEM budget with short
# high-level horizon H=1.
#
# Suggested use:
#   cd jobs/eval/hi/d50
#   sbatch joint_22368719_epoch25_d50_eval.sh

#SBATCH --partition=gpu_a100
#SBATCH --gpus=1
#SBATCH --job-name=hi_eval_joint22368719_d50
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=8
#SBATCH --time=03:00:00
#SBATCH --output=joint_22368719_epoch25_d50_eval_%j.out
#SBATCH --error=joint_22368719_epoch25_d50_eval_%j.err
...
export EVAL_SUBDIR="${EVAL_SUBDIR:-eval_joint_22368719_epoch25_d50_pscaled_h1_lowh2_b${EVAL_BUDGET}_job_${SLURM_JOB_ID:-$(date +%Y%m%d_%H%M%S)}}"
