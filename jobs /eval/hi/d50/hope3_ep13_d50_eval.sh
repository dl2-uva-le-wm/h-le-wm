...
# saved object checkpoint (epoch 13), using the standard d=50 H=2 GPU setup.

#SBATCH --partition=gpu_a100
#SBATCH --gpus=1
#SBATCH --job-name=hi_eval_h3e13_d50
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=8
#SBATCH --time=04:00:00
#SBATCH --output=hope3_ep13_d50_eval_%j.out
#SBATCH --error=hope3_ep13_d50_eval_%j.err
